...
describe("Checkout flow with form error and price validation", () => {
    ...
    uiTest(
        "should verify the full checkout flow: add products, open cart, complete checkout steps, and validate cart items and pricing",
        async () => {
            ...
            await step(
                "complete checkout and return to dashboard",
                async () => {
