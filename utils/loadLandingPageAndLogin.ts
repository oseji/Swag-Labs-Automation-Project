...
export const loadLandingPageAndLogin = async (
    ...
    if (testType === "happy path") {
        await step("navigate to landing page and log in", async () => {
    ...
    if (testType === "negative path") {
        ...
        await step("wait for negative path error message to load", async () => {
    ...
    if (testType === "no username") {
        ...
        await step("wait for no username error message to load", async () => {
